...
public class CourseService : ICourseService
{
    ...
    {
        var response = await _httpClient.GetAsync($"https://localhost:44353/api/Course");
    ...
    {
        var response = await _httpClient.GetAsync($"https://localhost:44353/api/Course/"+courseId);
        var content = await response.Content.ReadAsStringAsync();
